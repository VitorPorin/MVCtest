<?php
include_once('C:\xampp\htdocs\ConexaoAutista\ConexaoAutista\app\LoginController.php');
...
<body>
    <div class="imgFundo">
        <img src="../../public/IMG/imgKid2.jpg" class="imagemCrianca" alt="">
    </div>


    <form class="form_main" action="register.php" method="POST">
        ...
        <div class="signupContainer">
            ...
            <p>não tem uma conta? <a href="../../views/registro.php">faça uma agora!</a></p>
        </div>
    </form>

    <a href="http://localhost\../../views/home.php"><img src="../../public/IMG/Logo Conexão Autista 2.png" alt="Logo" class='logo' /></a>
</body>
